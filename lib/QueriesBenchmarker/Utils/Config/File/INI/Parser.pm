package QueriesBenchmarker::Utils::Config::File::INI::Parser;
...
sub getInstance {
    ...
    if (!defined($instance)){
        ...
        $instance = new QueriesBenchmarker::Utils::Config::File::INI::Parser(@_);
...
=head1 NAME
 ...
 QueriesBenchmarker::Utils::Config::File::INI::Parser
...
=head1 SYNOPSIS
 ...
 my $parser = QueriesBenchmarker::Utils::Config::File::INI::Parser(masterConfigFile=>$file);
