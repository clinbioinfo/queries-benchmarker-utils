package QueriesBenchmarker::Utils::Logger;
...
B<Description:> Instantiate QueriesBenchmarker::Utils::Logger object

B<Parameters:> 

 %args

B<Returns:> Returns a reference to QueriesBenchmarker::Utils::Logger
...
sub _initConfiguration {
    ...
    my $conf = q(
    log4perl.logger                    = sub {return QueriesBenchmarker::Utils::Logger::_getLogLevel();}

    log4perl.appender.Logfile          = Log::Log4perl::Appender::File
    log4perl.appender.Logfile.filename = sub { return QueriesBenchmarker::Utils::Logger::_getLogfile(); }
...
sub getInstance {
    ...
    if (!defined($instance)){
        ...
        $instance = new QueriesBenchmarker::Utils::Logger(@_);

        if (!defined($instance)){
            confess "Could not instantiate QueriesBenchmarker::Utils::Logger";
        }
    }
...
B<Description:> QueriesBenchmarker::Utils::Logger class destructor
...
=head1 NAME
 ...
 QueriesBenchmarker::Utils::Logger
...
=head1 SYNOPSIS
 ...
 my $obj = QueriesBenchmarker::Utils::Logger::getInstance();
