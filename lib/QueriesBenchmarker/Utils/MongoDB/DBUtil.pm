package QueriesBenchmarker::Utils::MongoDB::DBUtil;
...
sub getInstance {
    ...
    if (!defined($instance)){
        ...
        $instance = new QueriesBenchmarker::Utils::MongoDB::DBUtil(@_);

        if (!defined($instance)){

            confess "Could not instantiate QueriesBenchmarker::Utils::MongoDB::DBUtil";
        }
    }
    return $instance;
}
...
=head1 NAME
 ...
 QueriesBenchmarker::Utils::MongoDB::DBUtil
