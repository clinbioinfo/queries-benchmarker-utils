package QueriesBenchmarker::Utils::Mysql::DBUtil;
...
sub getInstance {
    ...
    if (!defined($instance)){
        ...
        $instance = new QueriesBenchmarker::Utils::Mysql::DBUtil(@_);

        if (!defined($instance)){

            confess "Could not instantiate QueriesBenchmarker::Utils::Mysql::DBUtil";
        }
    }
    return $instance;
}
...
=head1 NAME
 ...
 QueriesBenchmarker::Utils::Mysql::DBUtil
