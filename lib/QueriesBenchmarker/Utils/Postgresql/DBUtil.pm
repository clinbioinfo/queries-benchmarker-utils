package QueriesBenchmarker::Utils::Postgresql::DBUtil;
...
sub getInstance {
    ...
    if (!defined($instance)){
        ...
        $instance = new QueriesBenchmarker::Utils::Postgresql::DBUtil(@_);

        if (!defined($instance)){

            confess "Could not instantiate QueriesBenchmarker::Utils::Postgresql::DBUtil";
        }
    }
    return $instance;
}
...
=head1 NAME
 ...
 QueriesBenchmarker::Utils::Postgresql::DBUtil
